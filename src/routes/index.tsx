...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Frei Rui Guido Depiné — Memorial e Legado" },
      {
        name: "description",
        content:
          "Memorial de Frei Rui Guido Depiné, OFM (1942–2020): franciscano de Rodeio (SC) que dedicou a vida aos pobres e ao Hospital São Roque, em Piraquara (PR).",
      },
      { property: "og:title", content: "Frei Rui Guido Depiné — Memorial e Legado" },
      {
